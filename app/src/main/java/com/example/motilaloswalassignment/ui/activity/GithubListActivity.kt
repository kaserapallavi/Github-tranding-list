...
import com.example.motilaloswalassignment.ui.custom.recyclerview.RecyclerItemClickListener
import com.example.motilaloswalassignment.ui.custom.recyclerview.RecyclerLayoutClickListener
import com.example.motilaloswalassignment.ui.custom.recyclerview.RecyclerViewPaginator
...
import com.example.motilaloswalassignment.databinding.GithubListActivityBinding
import com.example.motilaloswalassignment.factory.ViewModelFactory
import com.example.motilaloswalassignment.ui.adapter.FilterListAdapter
import com.example.motilaloswalassignment.ui.adapter.GithubListAdapter
...
class GithubListActivity : AppCompatActivity(), RecyclerLayoutClickListener {
    ...
    private fun initialiseView() {
        ...
        binding.filterList.addOnItemTouchListener(
    ...
    override fun sharePost(githubEntity: GithubEntity) {
        ShareUtils.shareUrl(this, githubEntity.htmlUrl.toString())
    }
}
