package com.example.motilaloswalassignment.ui.adapter
...
import com.example.motilaloswalassignment.databinding.RepoListItemBinding
import com.squareup.picasso.Picasso

import java.util.ArrayList

class GithubListAdapter(private val context: Context, private val listener: RecyclerLayoutClickListener) : RecyclerView.Adapter<GithubListAdapter.CustomViewHolder>(), Filterable {
    ...
    inner class CustomViewHolder(private val binding: RepoListItemBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bindTo(githubEntity: GithubEntity) {
            ...
            binding.itemTime.text = String.format(context.getString(R.string.item_date),
                githubEntity.createdAt?.let { AppUtils.getDate(it) },
                githubEntity.createdAt?.let { AppUtils.getTime(it) })
